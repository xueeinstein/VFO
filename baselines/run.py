...
from baselines.common.cmd_util import common_arg_parser, parse_unknown_args, \
    make_mujoco_env, make_atari_env
...
# register maze environments
_game_envs['maze'] = set([
    'standard_maze',
    'mix_maze_task_1',
    'mix_maze_task_2',
    'stochastic_standard_maze',
    'stochastic_mix_maze_task_1',
    'stochastic_mix_maze_task_2',
])
...
def build_env(args):
    ...
    if env_type == 'mujoco':
        ...
        frame_stack_size = 1
        env = VecFrameStack(make_maze_env(env_id, nenv, seed), frame_stack_size)
    else:
